# 基于 CPG+PD+SAC 残差强化学习的人形机器人行走仿真
...
本系统同时具备工程应用价值和算法研究价值，既可以作为人形机器人运动控制的一个稳定基线，也可以用于残差强化学习、Sim2Real 迁移等方向的算法实验。希望这个项目可以给你带来一点思考和研究价值。
